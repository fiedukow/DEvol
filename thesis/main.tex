...
\lstset{language=C}
\begin{lstlisting}[frame=single,mathescape]
DifferentialEvolution($S$, $U$, $f$, $\mu$, $Cr$, $F$)
{
	X = $S$
	while (!stop) {
		V = Mutacja(X, U, $F$)
		Z = Krzyzowanie(X, V, $U$, $Cr$)
		X = Selekcja(Z, X, $f$)
	}
}
\end{lstlisting}
