source("src/ClassicDErand1bin.R")
source("src/named_functions.R")

runSuite = function()
{
  SUITE_NAME = "DE/rand/1/bin - basic setup"
  SUITE_DESCRIPTION = "Ten zestaw testów sprawdza jakość wyników klasycznego DE/rand/1/bin w typowych nastawach w funkcjach CEC2013."
  DIFF_FACTOR = 0.5
  INIT = I_UNIF
  SELECT = S_RAND
  CROSSOVER = C_BIN
