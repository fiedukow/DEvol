...
CEC_2013_1  = c(function(p) { cec2013(1,  p) }, "CEC 2013 #1",  "Sphere function." )
CEC_2013_2  = c(function(p) { cec2013(2,  p) }, "CEC 2013 #2",  "Rotated High Conditioned Elliptic Function." )
...
CEC_2013_9  = c(function(p) { cec2013(9,  p) }, "CEC 2013 #9",  "Rotated Weierstrass Function." )
CEC_2013_10 = c(function(p) { cec2013(10, p) }, "CEC 2013 #10", "Rotated Griewank's Function.")
